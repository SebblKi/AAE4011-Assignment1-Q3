...
![Vehicle Detection](images/detection_result.png)
...
![ROS Pipeline](images/ros_pipeline.png)
...
AI tools were used to assist with debugging and development tasks, including resolving ROS configuration issues, handling Python dependency conflicts, and integrating the YOLO model into a ROS node.

Although AI assistance helped accelerate development, manual debugging and testing were still required to ensure that the ROS nodes, Python environments, and GUI visualisation worked correctly together.
